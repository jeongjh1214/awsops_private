...
export async function GET(request: NextRequest) {
  ...
  const safeAccountId = accountIdParam && validateAccountId(accountIdParam) ? accountIdParam : undefined;
  const queryOpts = safeAccountId ? { accountId: safeAccountId } : undefined;
